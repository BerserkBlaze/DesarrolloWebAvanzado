...
function validarSoat(inicio, fin) {
  var fechaInicio = new Date(parseInt(inicio, 10)).getTime();
  var fechaFin = new Date(parseInt(fin, 10)).getTime();
...
function _soat() {
  _soat = asyncToGenerator( /*#__PURE__*/regenerator.mark(function _callee() {
    var response, json, container;
    return regenerator.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch('https://dwaapi.juvasquez88.now.sh/soatdwa');
          ...
          case 11:
            ...
            circulo1 = createElement('div', {
              id: 'circulo1',
              "class": 'circulo'
            }, ['']);
            circulo2 = createElement('div', {
              id: 'circulo2',
              "class": 'circulo'
            }, ['']);
            circulo3 = createElement('div', {
              id: 'circulo3',
              "class": 'circulo'
            }, ['']);
            circulo4 = createElement('div', {
              id: 'circulo4',
              "class": 'circulo'
            }, ['']);
            circulo5 = createElement('div', {
              id: 'circulo5',
              "class": 'circulo'
            }, ['']);
            ...
            if (SOAT1 == 365) {
              circulo1 = createElement('div', defineProperty({
                id: 'circulo1',
                "class": 'circulo'
              }, "id", 'valido'), ['']);
            } else {
            ...
            if (SOAT2 == 365) {
              circulo2 = createElement('div', defineProperty({
                id: 'circulo1',
                "class": 'circulo'
              }, "id", 'valido'), ['']);
            } else {
            ...
            if (SOAT3 == 365) {
              circulo3 = createElement('div', defineProperty({
                id: 'circulo1',
                "class": 'circulo'
              }, "id", 'valido'), ['']);
            } else {
            ...
            if (SOAT4 == 365) {
              circulo4 = createElement('div', defineProperty({
                id: 'circulo1',
                "class": 'circulo'
              }, "id", 'valido'), ['']);
            } else {
            ...
            if (SOAT5 == 365) {
              circulo5 = createElement('div', defineProperty({
                id: 'circulo1',
                "class": 'circulo'
              }, "id", 'valido'), ['']);
            } else {
            ...
            nav = createElement('nav', {
              id: 'nav1',
              "class": 'elementos'
            }, ['Status ', 'brand ', 'licensePlate ', 'soatValidFrom ', 'soatValidUntil']);
            element1 = createElement('div', {
              "class": 'elementos'
            }, [circulo1, ' ', vehicles.vehicles[0].brand, ' ', vehicles.vehicles[0].licensePlate, ' ', FechaIniV1, ' ', FechaExpV1]);
            element2 = createElement('div', {
              "class": 'elementos'
            }, [circulo2, ' ', vehicles.vehicles[1].brand, ' ', vehicles.vehicles[1].licensePlate, ' ', FechaIniV2, ' ', FechaExpV2]);
            element3 = createElement('div', {
              "class": 'elementos'
            }, [circulo3, ' ', vehicles.vehicles[2].brand, ' ', vehicles.vehicles[2].licensePlate, ' ', FechaIniV3, ' ', FechaExpV3]);
            element4 = createElement('div', {
              "class": 'elementos'
            }, [circulo4, ' ', vehicles.vehicles[3].brand, ' ', vehicles.vehicles[3].licensePlate, ' ', FechaIniV4, ' ', FechaExpV4]);
            element5 = createElement('div', {
              "class": 'elementos'
            }, [circulo5, ' ', vehicles.vehicles[4].brand, ' ', vehicles.vehicles[4].licensePlate, ' ', FechaIniV5, ' ', FechaExpV5]);
            container = createElement('div', {
              id: 'container'
            }, [title, nav, element1, element2, element3, element4, element5]);
